/* eslint-disable */
// Generated by Wrangler by running `wrangler types packages/api/src/worker-configuration.d.ts` (hash: c73cdcbbfd49ddba23747a5b8520623f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TOKEN_SIGNING_KEY">> {}
}
